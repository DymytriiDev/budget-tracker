...
export function SettingsPage() {
  ...
  const handleForceSync = async () => {
    setSyncing(true);
    // With granular sync, changes are pushed immediately - this just reloads from server
            ...
            <CardContent>
              <div className={`space-y-2 ${shaking ? "animate-shake" : ""}`}>
                ...
                <p className="text-xs text-muted-foreground">
                  Budget periods run from day {monthStartDay} of each month to
                  day {monthStartDay - 1 || 28} of the next.
                </p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-2">
                <Select
                  value={defaultOwnerId || "none"}
                  onValueChange={(v) =>
                    setDefaultOwnerId(v === "none" ? undefined : v)
                  }
                >
                  <SelectTrigger>
                ...
                <p className="text-xs text-muted-foreground">
                  When adding a new expense, the owner field will be pre-filled
                  with your selected default owner.
                </p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="border-border/50">
            ...
            <CardContent>
              <div className="space-y-2">
                ...
                <p className="text-xs text-muted-foreground">
                  All amounts in the app will be displayed in your selected
                  currency.
                </p>
              </div>
            </CardContent>
